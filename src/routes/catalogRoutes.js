...
router.get('/movement-types', catalogController.getMovementTypes);
router.get('/store', catalogController.getStoreCatalog);
router.get('/products', catalogController.getProducts);
router.get('/products/:idProducto', catalogController.getProductById);
