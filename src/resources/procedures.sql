...
CREATE OR REPLACE PROCEDURE FIDE_RECALCULAR_FACTURA_POR_ID_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_MARCA_INSERT_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_MARCA_UPDATE_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_MARCA_DELETE_SP(
    P_ID_MARCA IN FIDE_MARCA_TB.ID_MARCA%TYPE
)
IS
    V_ESTADO NUMBER := 2;
...
CREATE OR REPLACE PROCEDURE FIDE_PRODUCTO_IMAGEN_INSERT_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_PRODUCTO_IMAGEN_UPDATE_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_PRODUCTO_IMAGEN_DELETE_SP(
    P_ID_IMAGEN IN FIDE_PRODUCTO_IMAGEN_TB.ID_IMAGEN%TYPE
)
IS
    V_ESTADO NUMBER := 2;
...
BEGIN
    ...
    SET
        IDENTIFICACION = P_IDENTIFICACION,
        TOTAL_VENTA = ROUND(V_TOTAL_VENTA_CALCULADA, 2),
...
BEGIN
    ...
    UPDATE FIDE_VENTA_TB
    SET TOTAL_VENTA = (
        SELECT ROUND(NVL(SUM(TOTAL), 0), 2)
        FROM FIDE_VENTA_PRODUCTO_TB
        WHERE ID_VENTA = P_ID_VENTA
          AND ID_ESTADO = 1
    )
...
BEGIN
    ...
    V_SUBTOTAL := ROUND(V_TOTAL_VENTAS + V_TOTAL_DONACIONES, 2);
    V_IMPUESTO := ROUND(V_SUBTOTAL * NVL(P_TASA_IMPUESTO_APLICADA, 0.13), 2);
...
CREATE OR REPLACE PROCEDURE FIDE_PERRITO_IMAGEN_INSERT_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_PERRITO_IMAGEN_UPDATE_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_PERRITO_IMAGEN_DELETE_SP(
    P_ID_IMAGEN IN FIDE_PERRITO_IMAGEN_TB.ID_IMAGEN%TYPE
)
IS
    V_ESTADO NUMBER := 2;
...
CREATE OR REPLACE PROCEDURE FIDE_SOLICITUD_PREGUNTA_INSERT_SP(
...
CREATE OR REPLACE PROCEDURE FIDE_SOLICITUD_PREGUNTA_UPDATE_SP(
    P_ID_SOLICITUD IN FIDE_SOLICITUD_PREGUNTA_TB.ID_SOLICITUD%TYPE,
    P_ID_PREGUNTA  IN FIDE_SOLICITUD_PREGUNTA_TB.ID_PREGUNTA%TYPE,
    P_ID_ESTADO    IN FIDE_SOLICITUD_PREGUNTA_TB.ID_ESTADO%TYPE
)
...
CREATE OR REPLACE PROCEDURE FIDE_SOLICITUD_PREGUNTA_DELETE_SP(
    P_ID_SOLICITUD IN FIDE_SOLICITUD_PREGUNTA_TB.ID_SOLICITUD%TYPE,
    P_ID_PREGUNTA  IN FIDE_SOLICITUD_PREGUNTA_TB.ID_PREGUNTA%TYPE
)
IS
...
CREATE OR REPLACE PROCEDURE FIDE_EVIDENCIA_DELETE_SP(
    P_ID_EVIDENCIA IN FIDE_EVIDENCIA_TB.ID_EVIDENCIA%TYPE
)
IS
    V_ESTADO NUMBER := 2;
