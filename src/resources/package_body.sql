CREATE OR REPLACE PACKAGE BODY FIDE_KALO_PKG IS
    ...
    */
    ...
    FUNCTION FIDE_OBTENER_PREGUNTAS_POR_SOLICITUD_FN(
        P_ID_SOLICITUD IN FIDE_SOLICITUD_PREGUNTA_TB.ID_SOLICITUD%TYPE
    )
    RETURN SYS_REFCURSOR
    IS
        V_CURSOR_RESULTADO SYS_REFCURSOR;
    ...
    EXCEPTION
        ...
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error inesperado: ' || SQLERRM);
    END FIDE_OBTENER_PREGUNTAS_POR_SOLICITUD_FN;
    ...
    FUNCTION FIDE_OBTENER_SOLICITUDES_PREGUNTA_ADMIN_FN
    RETURN SYS_REFCURSOR
    IS
        V_CURSOR_RESULTADO SYS_REFCURSOR;
    BEGIN
    ...
    EXCEPTION
        ...
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error inesperado: ' || SQLERRM);
    END FIDE_OBTENER_SOLICITUDES_PREGUNTA_ADMIN_FN;

    FUNCTION FIDE_OBTENER_SOLICITUD_PREGUNTA_ADMIN_POR_PK_FN(
        P_ID_SOLICITUD IN FIDE_SOLICITUD_PREGUNTA_TB.ID_SOLICITUD%TYPE,
        P_ID_PREGUNTA  IN FIDE_SOLICITUD_PREGUNTA_TB.ID_PREGUNTA%TYPE
    )
    RETURN SYS_REFCURSOR
    IS
        V_CURSOR_RESULTADO SYS_REFCURSOR;
    ...
    EXCEPTION
        ...
        WHEN OTHERS THEN
            RAISE_APPLICATION_ERROR(-20001, 'Error inesperado: ' || SQLERRM);
    END FIDE_OBTENER_SOLICITUD_PREGUNTA_ADMIN_POR_PK_FN;
    ...
    /* PROCEDURE FIDE_SOLICITUD_PREGUNTA_TB INSERT */

    PROCEDURE FIDE_SOLICITUD_PREGUNTA_INSERT_SP(
        P_ID_SOLICITUD IN FIDE_SOLICITUD_PREGUNTA_TB.ID_SOLICITUD%TYPE,
        P_ID_PREGUNTA  IN FIDE_SOLICITUD_PREGUNTA_TB.ID_PREGUNTA%TYPE,
        P_ID_ESTADO    IN FIDE_SOLICITUD_PREGUNTA_TB.ID_ESTADO%TYPE
    )
    IS
    BEGIN

        INSERT INTO FIDE_SOLICITUD_PREGUNTA_TB(
            ID_SOLICITUD,
            ID_PREGUNTA,
            ID_ESTADO
        )
    ...
    EXCEPTION
        WHEN DUP_VAL_ON_INDEX THEN
            ROLLBACK;
            RAISE_APPLICATION_ERROR(-20002, 'La relación solicitud-pregunta ya existe.');
        WHEN VALUE_ERROR THEN
            ROLLBACK;
            RAISE_APPLICATION_ERROR(-20003, 'Error en tipo o tamaño de dato.');
        WHEN INVALID_NUMBER THEN
    ...
    /* PROCEDURE FIDE_SOLICITUD_PREGUNTA_TB UPDATE */

    PROCEDURE FIDE_SOLICITUD_PREGUNTA_UPDATE_SP(
        P_ID_SOLICITUD IN FIDE_SOLICITUD_PREGUNTA_TB.ID_SOLICITUD%TYPE,
        P_ID_PREGUNTA  IN FIDE_SOLICITUD_PREGUNTA_TB.ID_PREGUNTA%TYPE,
        P_ID_ESTADO    IN FIDE_SOLICITUD_PREGUNTA_TB.ID_ESTADO%TYPE
    )
    ...
    BEGIN
        ...
        UPDATE FIDE_SOLICITUD_PREGUNTA_TB
        SET
            ID_ESTADO = P_ID_ESTADO
        WHERE ID_SOLICITUD = P_ID_SOLICITUD
        ...
        IF V_HAY_UPDATE = 0 THEN
            RAISE_APPLICATION_ERROR(-20004, 'No existe la relación solicitud-pregunta.');
        END IF;
    ...
    /* PROCEDURE FIDE_SOLICITUD_PREGUNTA_TB DELETE LOGICO */

    PROCEDURE FIDE_SOLICITUD_PREGUNTA_DELETE_SP(
        P_ID_SOLICITUD IN FIDE_SOLICITUD_PREGUNTA_TB.ID_SOLICITUD%TYPE,
        P_ID_PREGUNTA  IN FIDE_SOLICITUD_PREGUNTA_TB.ID_PREGUNTA%TYPE
    )
    IS
    ...
    BEGIN
        ...
        FROM FIDE_SOLICITUD_PREGUNTA_TB
        WHERE ID_SOLICITUD = P_ID_SOLICITUD
          AND ID_PREGUNTA = P_ID_PREGUNTA
          AND ID_ESTADO = 1;
        ...
        IF V_RELACION_EXISTE = 0 THEN
            RAISE_APPLICATION_ERROR(
                -20006,
                'La pregunta no está asociada a la solicitud indicada.'
            );
        END IF;
